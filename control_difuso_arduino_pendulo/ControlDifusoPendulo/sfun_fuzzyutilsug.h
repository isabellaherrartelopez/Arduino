...
#define Merror 1.570796326795000
#define Mder 1.0
#define Mu 30
...
/* Define the input and output membership functions. */  
  ...
  /* Initialize  */
  fuzzy_system->emem->width[0] =0.75*Merror;  
  fuzzy_system->emem->width[1] =0.5*Merror;  
  fuzzy_system->emem->width[2] =0.5*Merror;  
  fuzzy_system->emem->width[3] =0.5*Merror;  
  fuzzy_system->emem->width[4] =0.75*Merror;    
  
  fuzzy_system->emem->center[0] =-0.75*Merror;  
  fuzzy_system->emem->center[1] =-0.25*Merror;  
  fuzzy_system->emem->center[2] =0.0*Merror;  
  fuzzy_system->emem->center[3] =0.25*Merror;  
  fuzzy_system->emem->center[4] =0.75*Merror;    
  
  
  fuzzy_system->edotmem->width[0] = 0.75*Mder;
  fuzzy_system->edotmem->width[1] = 0.5*Mder;
  fuzzy_system->edotmem->width[2] = 0.5*Mder;
  fuzzy_system->edotmem->width[3] = 0.5*Mder;
  fuzzy_system->edotmem->width[4] = 0.75*Mder;  

  fuzzy_system->edotmem->center[0] = -0.75*Mder;
  fuzzy_system->edotmem->center[1] = -0.25*Mder;
  fuzzy_system->edotmem->center[2] = 0.0*Mder;
  fuzzy_system->edotmem->center[3] = 0.25*Mder;
  fuzzy_system->edotmem->center[4] = 0.75*Mder;  

  fuzzy_system->outmem->center[0] = -1.0*Mu;
  fuzzy_system->outmem->center[1] = -0.6*Mu;
  fuzzy_system->outmem->center[2] = -0.3*Mu;
  fuzzy_system->outmem->center[3] = 0.0*Mu;
  fuzzy_system->outmem->center[4] = 0.3*Mu;  
  fuzzy_system->outmem->center[5] = 0.6*Mu;
  fuzzy_system->outmem->center[6] = 1.0*Mu;  
  
  fuzzy_system->Rules[0][0]=5;
  fuzzy_system->Rules[0][1]=5;
  fuzzy_system->Rules[0][2]=4;
  fuzzy_system->Rules[0][3]=4;
  fuzzy_system->Rules[0][4]=3;
  
  fuzzy_system->Rules[1][0]=5;
  fuzzy_system->Rules[1][1]=4;
  fuzzy_system->Rules[1][2]=4;
  fuzzy_system->Rules[1][3]=4;
  fuzzy_system->Rules[1][4]=3;
  
  fuzzy_system->Rules[2][0]=4;
  fuzzy_system->Rules[2][1]=4;
  fuzzy_system->Rules[2][2]=3;
  fuzzy_system->Rules[2][3]=2;
  fuzzy_system->Rules[2][4]=2;

  fuzzy_system->Rules[3][0]=3;
  fuzzy_system->Rules[3][1]=2;
  fuzzy_system->Rules[3][2]=2;
  fuzzy_system->Rules[3][3]=2;
  fuzzy_system->Rules[3][4]=1;
  
  fuzzy_system->Rules[4][0]=3;
  fuzzy_system->Rules[4][1]=2;
  fuzzy_system->Rules[4][2]=2;
  fuzzy_system->Rules[4][3]=1;
  fuzzy_system->Rules[4][4]=1;
