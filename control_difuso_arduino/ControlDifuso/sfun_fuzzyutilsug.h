...
/* Define the input and output membership functions. */  
  ...
  fuzzy_system->outmem->center[0] = -0.5*Mu;
  fuzzy_system->outmem->center[1] = -0.4*Mu;
  fuzzy_system->outmem->center[2] = -0.2*Mu;
  fuzzy_system->outmem->center[3] = 0.0*Mu;
  fuzzy_system->outmem->center[4] = 0.2*Mu;  
  fuzzy_system->outmem->center[5] = 0.4*Mu;
  fuzzy_system->outmem->center[6] = 0.5*Mu;  
  
  fuzzy_system->Rules[0][0]=0;
  fuzzy_system->Rules[0][1]=0;
  fuzzy_system->Rules[0][2]=1;
  fuzzy_system->Rules[0][3]=1;
  fuzzy_system->Rules[0][4]=1;
  
  fuzzy_system->Rules[1][0]=1;
  fuzzy_system->Rules[1][1]=1;
  fuzzy_system->Rules[1][2]=1;
  fuzzy_system->Rules[1][3]=1;
  fuzzy_system->Rules[1][4]=1;
  
  fuzzy_system->Rules[2][0]=2;
  fuzzy_system->Rules[2][1]=2;
  fuzzy_system->Rules[2][2]=3;
  fuzzy_system->Rules[2][3]=4;
  fuzzy_system->Rules[2][4]=4;

  fuzzy_system->Rules[3][0]=5;
  fuzzy_system->Rules[3][1]=5;
  fuzzy_system->Rules[3][2]=5;
  fuzzy_system->Rules[3][3]=5;
  fuzzy_system->Rules[3][4]=5;
  
  fuzzy_system->Rules[4][0]=5;
  fuzzy_system->Rules[4][1]=5;
  fuzzy_system->Rules[4][2]=5;
  fuzzy_system->Rules[4][3]=6;
  fuzzy_system->Rules[4][4]=6;
