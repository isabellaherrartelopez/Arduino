...
/* Includes ---------------------------------------------------------------- */
#include <PDM.h>
#include <ProyectoFinal_Audio_NanoBLE33_inferencing.h>
...
void turn_on_leds(int pred_index) {
  switch (pred_index)
  {
    case 0:     // Cinco:      [0] ==> Envia un 1
      switchCharacteristic.writeValue((byte)0x01);
      break;

    case 1:     // Cuatro:       [1] ==> Envia un 2
      switchCharacteristic.writeValue((byte)0x02);
      break;
    
    case 2:     // Dos:   [2] ==> Envia un 3
      switchCharacteristic.writeValue((byte)0x03);
      break;

    case 3:      // Fondo:[3] ==> Envia un 4
      switchCharacteristic.writeValue((byte)0x04);
      break;

    case 4:      // Tres:[4] ==> Envia un 5
      switchCharacteristic.writeValue((byte)0x05);
      break;

    case 5:      // Uno:[5] ==> Envia un 6
      switchCharacteristic.writeValue((byte)0x06);
      break;
  }
}
